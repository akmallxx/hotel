...
<div class="banner-image w-100 vh-100 d-flex justify-content-center align-items-center" id='home'>
  <h1 class="text-white" style="font-size: 60px;"><b>Halaman Admin</b></h1>
</div>
...
<!-- Footer -->
<footer id="kontak" class="text-center text-lg-start text-white" style="background-color: #1c2331">
    ...
    <div class="container text-center text-md-start mt-5">
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
          ...
          <hr class="mb-4 mt-0 d-inline-block mx-auto" style="width: 60px; background-color: #7c4dff; height: 2px" />
          <p><i class="fas fa-home mr-3"></i> Jl. Veteran No.1, Gambir, Kecamatan Gambir, Kota Jakarta Pusat, Bali 10110
          </p>
